...
def parse_arguments():
    ...
    parser.add_argument('-hs', '--shift', help='toggle to incorporate shift', type=bool, default=True)
    parser.add_argument('-s', '--save_path', help='path to ',
                        default=str(Path(__file__).parent.absolute() / 'integral_lookup_tables/original/'))
    ...
    if arguments.alphas is None:
        # arguments.alphas = [0.005, 0.006, 0.01, 0.012, 0.015, 0.018,0.02]
        arguments.alphas = [0.006, 0.012, 0.015, 0.018]
